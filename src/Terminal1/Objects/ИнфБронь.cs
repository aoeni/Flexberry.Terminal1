...
namespace IIS.Terminal1
{
    ...
    public class ИнфБронь : ICSSoft.STORMNET.DataObject
    {
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Terminal1.Рейс.
        /// </summary>
    ...
    public class DetailArrayOfИнфБронь : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Terminal1.DetailArrayOfИнфБронь members)

        // *** End programmer edit section *** (IIS.Terminal1.DetailArrayOfИнфБронь members)
        ...
        /// </summary>
        public DetailArrayOfИнфБронь(IIS.Terminal1.Рейс fРейс) : 
                base(typeof(ИнфБронь), ((ICSSoft.STORMNET.DataObject)(fРейс)))
        {
        }
        
        public IIS.Terminal1.ИнфБронь this[int index]
        {
            get
            {
                return ((IIS.Terminal1.ИнфБронь)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Terminal1.ИнфБронь dataobject)
        {
